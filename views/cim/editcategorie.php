...
<div class="form-style-10">
	<form class="tabaut" method="post" action="<?php echo URL."cim/editSave/".$this->user[0]['row_id'];?>">
	   
	    <div class="section"><span>1</span> Chapitre</div>
		<div class="inner-wrap"><?php HTML::chapitre('CODECIM0','chapitre',$this->user[0]['c_chapi'],View::nbrtostring('chapitre','IDCHAP',$this->user[0]['c_chapi'],'CHAP'));?></div>	
		<div class="section"><span>2</span>Categorie</div>
		<div class="inner-wrap"><input  type="text" name="diag_nom" value="<?php echo $this->user[0]['diag_nom'];?>"/></div>
		<div class="section"><span>3</span>Code CIM 10</div>
		<div class="inner-wrap"><input  type="text" name="diag_cod" value="<?php echo $this->user[0]['diag_cod'];?>"/></div>
	    </br>
