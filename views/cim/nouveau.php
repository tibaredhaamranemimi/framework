...
<div class="form-style-10">
	<form class="tabaut" method="post" action="<?php echo URL;?>cim/create/">
	   
	    <div class="section"><span>1</span> Chapitre</div>
		<div class="inner-wrap"><?php HTML::chapitre('CODECIM0','chapitre','0','Chapitre');?></div>
		<div class="section"><span>2</span>Categorie</div>
		<div class="inner-wrap"><input  type="text" name="diag_nom" value="x"/></div>
		<div class="section"><span>3</span>Code CIM 10</div>
		<div class="inner-wrap"><input  type="text" name="diag_cod" value="x"/></div>
	    </br>
