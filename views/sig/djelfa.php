...
<?php $root=$data['root'];?>	
<text class="label" id="country_name1" x="20" y="30"><?php echo $data['t1'];?></text>  	  
<text class="label" id="country_name1" x="20" y="47"><?php echo $data['t2'];?></text>  	  
     <g
	...
	<path 
	fill = "<?php echo $data['927'];?>" stroke="black" onmouseover="displayName('Hassi-fedoul')" "	
...
<text class="label" id="country_name" x="20" y="65"       ><?php echo $data['t3'];?></text>	
