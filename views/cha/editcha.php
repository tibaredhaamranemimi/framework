...
<div class="form-style-10">
	<form class="tabaut" method="post" action="<?php echo URL."cha/editSave/".$this->user[0]['IDCHAP'];?>">
	   
	    <div class="section"><span>1</span> Chapitre</div>
		<div class="inner-wrap"><input  type="text" name="CHAP" value="<?php echo $this->user[0]['CHAP'];?>"/></div>
