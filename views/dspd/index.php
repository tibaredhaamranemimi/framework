...
<?php
		...
		echo'<table>';$colspan=13;
			...
			echo'<th class="crtldate">Structure</th>';
			...
			echo '<td align="left"style="width:100px;" >'.HTML::nbrtostring('structure','id',$value['STRUCTURED'],'structure').'</td>';
		...
		HTML::multigraphe(30,340,'Décés Par annee et sexe  Arret Au : ','deceshosp','DINS','SEX','M','F',null) ;
		echo "</div>";
...
<?php 
	...
	// {
		...
		// echo '<a href="'.URL.'x/x/0">x</a>';echo '&nbsp;';
	// }
	echo '<a class="DECES"  id="annee"  href="'.URL.$ctrl.'/graphe/0">Année</a>';echo '&nbsp;'; 
...
<?php 
	...
	echo '<a class="DECES"  id="mois"  href="'.URL.$ctrl.'/graphe/1">Mois</a>';echo '&nbsp;';
?>
</div>
