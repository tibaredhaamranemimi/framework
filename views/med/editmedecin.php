...
<div class="sheader2l"> Modifier un médecin</div>
<div class="sheader2r">MSPRH</div>
<?php
echo '<div class="contentl">';?>
<div class="form-style-10">
	<form class="tabaut" method="post" action="<?php echo URL."med/editSave/".$this->user[0]['id'];?>">
...
<div class="scontentl2">Modifier un médecin</div>		
