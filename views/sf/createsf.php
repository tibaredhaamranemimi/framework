...
<div class="sheader2l"> Créer une sage-femme</div>
<div class="sheader2r">MSPRH</div>
<?php
echo '<div class="contentl">';?>
<div class="form-style-10">
	<form class="tabaut" method="post" action="<?php echo URL;?>sf/sfSave">
		<div class="section"><span>2</span>Nom</div>
		<div class="inner-wrap"><input  type="text" name="Nom" value="" onkeyup="javascript:this.value=this.value.toUpperCase();" required=""      /></div>
		<div class="section"><span>3</span>Prénom</div>
		<div class="inner-wrap"><input  type="text" name="Prenom" value="" onkeyup="javascript:this.value=this.value.toUpperCase();" required=""  /></div>
	    </br>
...
<div class="scontentl2">Créer une sage-femme</div>		
