...
<?php
		...
		echo'<table>';$colspan=15;
			...
			echo'<th class="crtl">HD</th>';
			echo'<th class="crtl">SD</th>';
			...
			echo '<td align="center" style="width:10px;" ><a target="_blank" title="Edition non autoriser"  href="'.URL.$ctrl.'/*/'.$value['id'].'" ><img src="'.URL.'public/images/edit.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo '<td align="center" style="width:10px;" ><a class="delete" title="Suppression non autoriser"  href="'.URL.$ctrl.'/*/'.$value['id'].'" ><img src="'.URL.'public/images/delete.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			}
