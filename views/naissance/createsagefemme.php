...
<div class="sheader2l">liste des sages femmes </div><div class="sheader2r">***</div>
<div class="contentl formaut">
<div class="form-style-10   ">
<form method="post" action="<?php echo URL;?>naissance/sagefemmeSave/">
...
foreach($this->userListview as $key => $value)
			...
			echo '<td align="center" style="width:10px;" ><a class="delete" title="supprimer"  href="'.URL.'dashboard/deletesagefemme/'.$value['id'].'/'.$value['structure'].'/'.'" ><img src="'.URL.'public/images/delete.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo '</tr>';			
			}
echo "</table>";	
