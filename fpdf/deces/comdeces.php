...
$pdf->SetXY(5,40);$pdf->cell(290,5,html_entity_decode(utf8_decode("Commune de residence : ".$pdf->nbrtostring("com","IDCOM",$SERVICEHOSPIT,"COMMUNE"))),0,0,'C',0,0);
...
$query = "SELECT * FROM deceshosp where COMMUNER=$SERVICEHOSPIT and STRUCTURED=$STRUCTURED  order by  DINS ";
