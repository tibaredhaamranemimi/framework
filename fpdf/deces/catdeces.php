...
$pdf->SetXY(5,40);$pdf->cell(290,5,html_entity_decode(utf8_decode("Categorie cim  : ".$pdf->nbrtostring("cim","row_id",$SERVICEHOSPIT,"diag_nom"))),0,0,'C',0,0);
...
$query = "SELECT * FROM deceshosp where CODECIM=$SERVICEHOSPIT and STRUCTURED=$STRUCTURED  order by  DINS ";
