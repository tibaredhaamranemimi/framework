...
{
if($row->Days >= 28){header('location: ../dashboard/search/0/10?o=NOM&q=');}
...
$pdf->SetXY(64,30.5);$pdf->Write(0,'ETABLISSEMENT DE SANTE : '.$pdf->nbrtostring('structure','id',intval(trim($row->STRUCTURED)),'structure'));
$pdf->SetTextColor(255,0,0);
$pdf->SetXY(80,75);$pdf->Write(0,$row->NOM.'_'.$row->PRENOM);
$pdf->SetXY(80,75+6);$pdf->Write(0,$pdf->nbrtostring('structure','id',intval(trim($row->STRUCTURED)),'structure'));
