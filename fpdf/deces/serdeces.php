...
$pdf->SetXY(5,40);$pdf->cell(290,5,html_entity_decode(utf8_decode("Service : ".$pdf->nbrtostring("servicedeces","id",$SERVICEHOSPIT,"service"))),0,0,'C',0,0);
...
$query = "SELECT * FROM deceshosp where SERVICEHOSPIT=$SERVICEHOSPIT and STRUCTURED=$STRUCTURED  order by  DINS ";
