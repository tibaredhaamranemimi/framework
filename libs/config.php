<?php
define('msp', 'Ministère de la santé de la population et de la réforme hospitalière');
...
define('EDRSFR', 'Système électronique d\'enregistrement des décès');
define('EDRSUS', 'Electronic Death Registration System');
