...
$pdf->Text(5,105,"1) FNS ,Groupage ,RH ,RAI si RH Negatif. ");
$pdf->Text(5,120,"2) Urée ,Creatinemie ,Chimie des urines. ");
$pdf->Text(5,135,"3) Glycemie ,HbA1C si Glycemie > 1.3 g/l  ,Calcemie. ");
$pdf->Text(5,150,"4) TP,INR ,Ionogramme-sanguin. ");
$pdf->SetTextColor(0,0,255);
...
$pdf->Text(103+145,70,"Age : _ _ _ _Ans");$pdf->SetTextColor(0,0,0);$pdf->Text(115+145,70,$result->AGE2);$pdf->SetTextColor(0,0,255);
...
$pdf->SetTextColor(0,0,0);
$pdf->Text(5+145,105,"1) THORAX.");
$pdf->Text(5+145,120,"2) ECG.");
$pdf->Text(5+145,135,"3) ECHOGRAPHIE-OBSTETRICAL.");
$pdf->Text(5+145,150,"4) ERCF.");
$pdf->SetTextColor(0,0,255);
$pdf->SetFont('aefurat', '', 12);
