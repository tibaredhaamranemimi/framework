...
$pdf->SetXY(5,40);$pdf->Cell(135,5,"إستمارة تسجيل الولادة",0,1,'C',1,0);
$pdf->SetXY(5,48);$pdf->Cell(135,5,"BULLETIN D'INSCRIPTION MATARNITÉ",0,1,'C',1,0);
...
$pdf->Text(5,60,"Je soussigné,directeur de l'Etablissement public ".$pdf->nbrtostring("structure","id",$result->STRUCTURED,"structure"));
$pdf->Text(5,70,"Certifie avoir procedé ce jour : ".date('d-m-Y'));     
$pdf->Text(5,80,"A l'inscription de La nommée : ".$result->NOM2."_".$result->PRENOM2); 
$pdf->Text(5,90,"Agée de : ".$result->AGE2." Ans");
$pdf->Text(5,100,"Sous le N° : ".$result->id);
$pdf->Text(5,110,"Adresse :");
$pdf->Text(26,110,$result->ADRESSE4.'_'.$pdf->nbrtostring("com","IDCOM",$result->COMMUNE4,"COMMUNE"));
$pdf->Text(5,120,"Téléphone portable / professionne :");
$pdf->Text(5,130,"Donne droit a une hospitalisation pour accouchement prevu le :");
$pdf->SetTextColor(255,0,0);$pdf->SetTextColor(0,0,0);
$pdf->SetTextColor(0,0,255);
$pdf->SetFont('aefurat', '', 12);
$pdf->Text(100,150,"Le ".date("d-m-Y"));
$pdf->Text(100,160,"LE DIRECTEUR");
...
$pdf->SetFont('aefurat', '', 15);
$pdf->SetXY(150,40);$pdf->Cell(135,5,"ﻣذﻛرة ﻣﻌﻠوﻣﺎت",0,1,'C',1,0);
$pdf->SetXY(150,48);$pdf->Cell(135,5,"NOTE D'INFORMATION",0,1,'C',1,0);
$pdf->SetFont('aefurat', '', 14);
$pdf->Text(5+145,60,"Delivrée par le Directeur de l'etablissement :_ _ _ _ _ _ _ _ _ _ _ ");
$pdf->Text(5+145,70,"A Mr/Melle :_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _");
$pdf->SetTextColor(255,0,0);$pdf->Text(35+145,70,$result->NOM3.'  '.$result->PRENOM5);$pdf->SetTextColor(0,0,255);
$pdf->Text(103+145,70,"Age   01 jours");
$pdf->Text(5+145,80,"Domicile :_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _");
$pdf->SetTextColor(255,0,0);$pdf->Text(26+145,80,$result->ADRESSE4.'_'.$pdf->nbrtostring("com","IDCOM",$result->COMMUNE4,"COMMUNE"));$pdf->SetTextColor(0,0,0);

$pdf->Text(5+145,$pdf->GetY()+10,"DOCUMENT A FOURNIR LE JOUR DE L'HOSPITALISATION");
$pdf->Text(5+145,$pdf->GetY()+15,"1 - LE LIVRET DE FAMMILE");
$pdf->Text(5+145,$pdf->GetY()+10,"2 - UNE PIECE D'IDENTITE");
$pdf->Text(5+145,$pdf->GetY()+10,"3 - CARTE CHIFFA (N° D'ASSURANCE)");
$pdf->Text(5+145,$pdf->GetY()+10,"4 - BULLETIN D'INSCRIPTION MATARNITÉ");
$pdf->Text(5+145,$pdf->GetY()+10,"5 - BILAN BIOLOGIQUE ET RADIOLOGIQUE");

$pdf->SetTextColor(0,0,255);
$pdf->SetFont('aefurat', '', 12);
$pdf->Text(100+145,150,"Le ".date("d-m-Y"));
$pdf->Text(100+145,160,"LE DIRECTEUR");
