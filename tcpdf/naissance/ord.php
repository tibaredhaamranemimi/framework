...
//http://www.pharmnet-dz.com/
if($result->MAC=='VB') {
	if($result->VMN=='V') {
	$pdf->Text(5,$pdf->GetY()+10,"1) CEPHALEX gellule 500 mg ");$pdf->Text(120,$pdf->GetY(),"2bts ");
	$pdf->Text(15,$pdf->GetY()+5,"2gel x 2/jour pendant 10jours ");
	$pdf->Text(5,$pdf->GetY()+10,"2) FERRO SANOL GYN 454,13MG");$pdf->Text(120,$pdf->GetY(),"1bts ");
	$pdf->Text(15,$pdf->GetY()+5,"1cp x 2/jour pendant 10jours ");
	$pdf->Text(5,$pdf->GetY()+10,"3) INNOHEP 3 500UI ANTI-XA/0,35ML SOL.INJ.SC");$pdf->Text(120,$pdf->GetY(),"03bts ");
	$pdf->Text(15,$pdf->GetY()+5,"1inj sc x 1/jour pendant 06jours ");
	}
...
$pdf->SetFont('aefurat', '', 15);
$pdf->SetXY(150,40);$pdf->Cell(135,5,"وصــفــة",0,1,'C',1,0);
$pdf->SetXY(150,48);$pdf->Cell(135,5,"ORDONNACE",0,1,'C',1,0);
$pdf->SetFont('aefurat', '', 14);
$pdf->Text(5+145,60,"Delivrée par le Docteur :_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ");
...
if($result->MAC=='VB') {
	if($result->VMN=='V') {
	$pdf->Text(5+145,$pdf->GetY()+10,"1) eosine acqueuse 1% ");$pdf->Text(120+145,$pdf->GetY(),"1flc ");
	$pdf->Text(15+145,$pdf->GetY()+5,"1 appl x 1/jour pendant 10jours "); 
	$pdf->Text(5+145,$pdf->GetY()+10,"2) vitabac collyre ophtalmique");$pdf->Text(120+145,$pdf->GetY(),"1bts ");
	$pdf->Text(15+145,$pdf->GetY()+5,"1gtte x 1/jour pendant 10jours ");
	}

	if($result->VMN=='M') {
	$pdf->Line(5+145 ,90 ,142+143 ,170 );
	}
}
...
if($result->MAC=='VH') {
	...
	$pdf->Text(5+145,$pdf->GetY()+10,"2) vitabac collyre ophtalmique");$pdf->Text(120+145,$pdf->GetY(),"1bts ");
	$pdf->Text(15+145,$pdf->GetY()+5,"1gtte x 1/jour pendant 10jours ");
	$pdf->Text(5+145,$pdf->GetY()+10,"3) premalac lait ");$pdf->Text(120+145,$pdf->GetY(),"1bts ");
	$pdf->Text(15+145,$pdf->GetY()+5,"1tete x 6/jour pendant 10jours ");
	}
...
$pdf->SetTextColor(0,0,255);
$pdf->SetFont('aefurat', '', 12);
$pdf->Text(100+145,160,"Le Medecin");
